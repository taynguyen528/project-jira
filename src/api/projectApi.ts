...
export const projectApi = {
    ...
    }): Promise<ApiResponse<{ taskId: number; originalEstimate: number }>> => {
        return privateClient.put("/Project/updateEstimate", data);
    },
    ...
    > => {
        return privateClient.put("/Project/updateTimeTracking", data);
    },
};
