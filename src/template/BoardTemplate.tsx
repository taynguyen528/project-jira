...
import { ModalAddNewUserProject, ModalTaskDetail } from "components";
...
export const BoardTemplate = () => {
    ...
    const [selectedTask, setSelectedTask] = useState<LstTaskDeTail | null>(
        null
    );
            ...
            <div className="flex gap-4 w-full mt-[50px]">
                {listTask.map((taskGroup) => (
                    ...
                    >
                        ...
                        <div className="p-2">
                            {renderTasks(taskGroup.lstTaskDeTail)}
                        </div>
                    </div>
                ))}
            </div>
